...
TITLE_DOMAINS = {
    ...
    "strategy": [
        ...
        "strategic advisor", "strategic programs", "strategy & planning", "strategic operations", "strategic finance", "strategic partnerships",
...
NON_PRODUCT_ROLES = [
    ...
    # "project manager", "project management", "programme manager", "program manager", # These are now explicitly in scope for strategy roles.

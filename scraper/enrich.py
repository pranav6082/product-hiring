...
DIRTY_COMPANY_PATTERNS = re.compile(
    ...
    r'|data analyst|growth analyst|founding team|founding member', # Re-added 'founding team' and 'founding member' as they are often part of company names, not just roles.
    re.IGNORECASE,
)

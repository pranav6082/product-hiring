    ...
    cur.execute(r"""
        ...
        ORDER BY
          ...
          CASE
            ...
            WHEN review_status = 'pending' AND india_hiring = 'unknown' AND COALESCE(norm_function, domain) = 'strategy' THEN 1
...
def run():
    ...
    for row in jobs:
        ...
        try:
            ...
            # Removed startup-context guard for 'strategic initiatives' as it was overly restrictive.
            # Rely on other quality checks to filter out irrelevant roles.
